  ...
  >  
      <div className="relative tbscrool max-w-[700px] max-h-[250px] mr-4 overflow-auto ">
        ...
        <table className=" relative">
          <thead className="text-xs text-white uppercase bg-primary-600 sticky top-0">
            <tr>
                <th scope="col" className="py-3 px-6 px-auto border border-gray-400 flex-nowrap max-w-xs truncate">
                 {t('date2')}
                </th>
                <th scope="col" className="py-3 px-12 border border-gray-400 max-w-xs truncate">
                {t('destination')}
                </th>
                <th scope="col" className="border px-3 border border-gray-400  max-w-xs truncate">
                {t('vehicle')}
                </th>
                <th scope="col" className="py-3 px-6 border border-gray-400  max-w-xs truncate">
                {t('departure')}
                </th>
                <th scope="col" className="py-3 px-6 border border-gray-400  max-w-xs truncate">
                {t('arrival')}
                </th>
                <th scope="col" className="py-3 px-2  border border-gray-400  max-w-xs truncate">
                {t('Round')}
                </th>
                <th scope="col" className="py-3 px-2 border border-gray-400  max-w-xs truncate">
                {t('purchase')}
                ...
                <th scope="col" className="px-2 py-3 border border-gray-400  max-w-xs truncate">
                {t('delete')}
                </th>
            </tr>
        </thead>
