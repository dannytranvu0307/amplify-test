...
const SwitchButton = ({isOn,setIsOn,setSelectedObject2 , setData, data}) => {
...
<div className='flex py-2 '>
 ...
 <label className="relative inline-flex items-center mr-5 cursor-pointer ">
  <input type="checkbox" value="" className="sr-only peer"  onChange={()=>{setIsOn(!isOn),setSelectedObject2(null)}} disabled ={isDisable} />
