    ...
    <div className='pt-3 w-full'>
        <div className='flex pb-[40%] w-full'>
            <div className='flex-auto'>
               ...
               <div className=' '><input placeholder={t("start_bus_pla")} className={`w-full border-[1px] border-black rounded h-8 px-2 ${error.departure&&("border-red-500 bg-red-100")}`}value={data.departure} onChange={e=>{setData({...data,departure:e.target.value}),setError({...error,departure:false})}}/></div> 
            </div>
